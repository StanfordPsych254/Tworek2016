...
To achieve 80% power, I would need to run 110 participants. To account for the exclusion of approximately 19% of all participants, I will run 136 participants ($136 - 136 \times .19 = 110$). 
...
I will conduct a linear mixed-effects model. **The key-analysis of interest is the p-value of the coefficient for the interaction between inherence bias and typicality.**
...
The original paper excluded participants that failed two or more of the four attention checks. I also excluded participants who put "0" for both the should and right/wrong questions on more than 2 prompts, to eliminate participants who just clicked the "next" button without recording a response. 
